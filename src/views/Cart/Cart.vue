<template>
  <div class="container">
    ...
    <div v-for="itr in len" :key="itr" class="row mt-2 pt-3 justify-content-around">
      <div class="col-2" v-if="carts"></div>
...
<!--          <p id="item-description" class="card-text font-italic mb-0">{{cartItem[itr-1].pDescription.substring(0,90)}}...</p>-->
          <p id="item-price" class="mb-0 font-weight-bold">R$ {{cartItem[itr-1].pPrice}} por unidade</p>
          ...
          <p id="item-total-price" class="mb-0">Preço: R$ <span class="font-weight-bold">{{cartItem[itr-1].pPrice*cartItem[itr-1].pQuantity}}</span></p>
