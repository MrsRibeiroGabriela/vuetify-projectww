    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h4 class="pt-3">Id do Pedido: {{orderID}}</h4>
            </div>
        </div>
        ...
        <div v-for="(orderItem, index) in orderItems" :key="index" class="row mt-2 pt-3 justify-content-around">
            ...
            <div class="col-md-5 px-3">
                <div class="card-block px-3">
                    ...
                    <p id="item-price" class="mb-0 font-weight-bold">R${{orderItem.product.price}} por unidade</p>
                    <p id="item-quantity" class="mb-0">Quantidade: {{orderItem.quantity}}</p>
                    <p id="item-total-price" class="mb-0">
                        Preço Total: R$<span class="font-weight-bold">{{ orderItem.price * orderItem.quantity}}</span>
                    </p>
                </div>
            </div>
            <div class="col-1"></div>
